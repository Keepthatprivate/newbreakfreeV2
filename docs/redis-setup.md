...
Redis is **required** for BoilerSaaS to cache session validation and organization data, providing ~90% performance improvement.
...
For BoilerSaaS specific issues, check the main README or open an issue on GitHub.
