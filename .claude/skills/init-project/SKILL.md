---
name: init-project
description: Initialize BoilerSaaS project with app name, purpose, theme, and landing page content
argument-hint: "[app-name]"
---

# Init Project - BoilerSaaS Initialization Workflow

<objective>
Initialize a BoilerSaaS project by gathering project information, updating CLAUDE.md, configuring app settings, applying a theme from tinte.dev, and customizing the landing page copy.
</objective>

<when_to_use>
Use this workflow when:
- Starting a new project based on BoilerSaaS
- Reconfiguring an existing BoilerSaaS project with new branding
