...
<overview>
Unit tests in BoilerSaaS use Vitest with React Testing Library. Tests are located in `__tests__/` directory and use `happy-dom` environment for lightweight DOM simulation.
</overview>
