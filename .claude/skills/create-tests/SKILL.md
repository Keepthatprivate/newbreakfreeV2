...
<objective>
Create comprehensive tests for BoilerSaaS application using Vitest for unit tests and Playwright for e2e tests. Ensure proper mocking, organization logic handling, and test data management.
</objective>
