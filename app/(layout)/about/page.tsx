...
export const metadata: Metadata = {
  ...
  description:
    "Learn about BoilerSaaS, our mission to empower content creators with powerful testimonial collection, and meet the founder behind the platform.",
      ...
      <SectionLayout size="lg" variant="transparent">
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            ...
            >
              BoilerSaaS is built with a long-term vision and unwavering
              commitment to our users. We understand that choosing a platform
              means trusting us with your most valuable asset - your reputation
