...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the BoilerSaaS team. We're here to help with any questions about testimonial collection, platform features, or technical support.",
      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
        <div className="bg-muted/10 relative flex items-center justify-end px-6 py-24 backdrop-blur-sm sm:py-32 lg:px-12">
          <div className="relative z-10 mx-auto w-full max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            >
              Have questions about BoilerSaaS? Need help with testimonial
              collection or want to share feedback? I'm here to help and always
              excited to hear from our community.
            </Typography>
